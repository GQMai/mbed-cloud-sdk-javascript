...
export class DeviceRepository extends Repository {
     ...
     */
    addToGroup(request, deviceGroupId) {
            ...
            return apiWrapper(resultsFn => {
                this.client._CallApi({
                    ...
                    query: {
                        ...
                        bootstrap_expiration_date__in: extractFilter(pageOptions.filter, "bootstrapExpirationDate", "in"),
                        bootstrap_expiration_date__nin: extractFilter(pageOptions.filter, "bootstrapExpirationDate", "nin"),
                        bootstrap_expiration_date__lte: extractFilter(pageOptions.filter, "bootstrapExpirationDate", "lte"),
                        bootstrap_expiration_date__gte: extractFilter(pageOptions.filter, "bootstrapExpirationDate", "gte"),
                        bootstrapped_timestamp__in: extractFilter(pageOptions.filter, "bootstrappedTimestamp", "in"),
                        bootstrapped_timestamp__nin: extractFilter(pageOptions.filter, "bootstrappedTimestamp", "nin"),
                        bootstrapped_timestamp__lte: extractFilter(pageOptions.filter, "bootstrappedTimestamp", "lte"),
                        bootstrapped_timestamp__gte: extractFilter(pageOptions.filter, "bootstrappedTimestamp", "gte"),
                        ...
                        connector_expiration_date__in: extractFilter(pageOptions.filter, "connectorExpirationDate", "in"),
                        connector_expiration_date__nin: extractFilter(pageOptions.filter, "connectorExpirationDate", "nin"),
                        connector_expiration_date__lte: extractFilter(pageOptions.filter, "connectorExpirationDate", "lte"),
                        connector_expiration_date__gte: extractFilter(pageOptions.filter, "connectorExpirationDate", "gte"),
                        ...
                        device_execution_mode__in: extractFilter(pageOptions.filter, "deviceExecutionMode", "in"),
                        device_execution_mode__nin: extractFilter(pageOptions.filter, "deviceExecutionMode", "nin"),
                        ...
                        enrolment_list_timestamp__in: extractFilter(pageOptions.filter, "enrolmentListTimestamp", "in"),
                        enrolment_list_timestamp__nin: extractFilter(pageOptions.filter, "enrolmentListTimestamp", "nin"),
                        enrolment_list_timestamp__lte: extractFilter(pageOptions.filter, "enrolmentListTimestamp", "lte"),
                        enrolment_list_timestamp__gte: extractFilter(pageOptions.filter, "enrolmentListTimestamp", "gte"),
     ...
     * @param deviceGroupId - The ID of the group.
     */
    removeFromGroup(request, deviceGroupId) {
        return apiWrapper(resultsFn => {
            this.client._CallApi({
     ...
     */
    renewCertificate(certificateName, id) {
        return apiWrapper(resultsFn => {
            this.client._CallApi({
