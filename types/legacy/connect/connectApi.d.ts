...
export declare class ConnectApi extends EventEmitter {
     ...
     * @event
     */
    static readonly EVENT_NOTIFICATION: string;
    /**
     * List of new devices that have registered (with resources)
     * @event
     */
    static readonly EVENT_REGISTRATION: string;
    /**
     * List of devices that have updated registration
     * @event
     */
    static readonly EVENT_REREGISTRATION: string;
    /**
     * List of devices that were removed in a controlled manner
     * @event
     */
    static readonly EVENT_DEREGISTRATION: string;
    /**
     * List of devices that were removed because the registration has expired
     * @event
     */
    static readonly EVENT_EXPIRED: string;
    private static readonly ASYNC_KEY;
    private static readonly DELAY_BETWEEN_RETRIES;
    private static readonly MAXIMUM_NUMBER_OF_RETRIES;
    /**
    ...
    private reverseNormalizePath;
    private handleAsync;
    private forceClearWebhook;
}
