...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var n=e("../../common/functions"),o=function(){function e(e,t){this._api=t;for(var r in e)e.hasOwnProperty(r)&&(this[r]=e[r])}return e.prototype.update=function(e){var t=this;return n.asyncStyle(function(e){t._api.updateAccount(t,e)},e)},e}();r.Account=o},{"../../common/functions":42}],14:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var n=e("./apiKey"),o=function(){function e(){}return e.map=function(e,t){return new n.ApiKey({name:e.name,ownerId:e.owner,groups:e.groups,id:e.id,key:e.key,status:e.status,createdAt:e.created_at,creationTime:e.creation_time,lastLoginTime:e.last_login_time},t)},e.addMap=function(e){return{name:e.name,status:e.status,owner:e.ownerId,groups:e.groups}},e.updateMap=function(e){return{name:e.name,status:e.status,owner:e.ownerId}},e}();r.ApiKeyAdapter=o},{"./apiKey":15}],17:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var n=e("./group"),o=function(){function e(){}return e.map=function(e,t){return new n.Group({id:e.id,accountId:e.account_id,name:e.name,userCount:e.user_count,apiKeyCount:e.apikey_count,createdAt:e.created_at},t)},e}();r.GroupAdapter=o},{"./group":17}],19:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var n=function(){function e(e){for(var t in e)e.hasOwnProperty(t)&&(this[t]=e[t])}return e}();r.LoginHistory=n},{}],20:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var n=e("./loginHistory"),o=function(){function e(){}return e.map=function(e){return new n.LoginHistory({date:e.date,userAgent:e.user_agent,ipAddress:e.ip_address,success:e.success})},e}();r.LoginHistoryAdapter=o},{"./loginHistory":19}],21:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var n=function(){function e(e){for(var t in e)e.hasOwnProperty(t)&&(this[t]=e[t])}return e}();r.Policy=n},{}],22:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var n=e("./policy"),o=function(){function e(){}return e.map=function(e){return new n.Policy({action:e.action,allow:e.allow,feature:e.feature,resource:e.resource})},e}();r.PolicyAdapter=o},{"./policy":21}],23:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
Object.defineProperty(r,"__esModule",{value:!0});var n=function(){function e(e){var t=this;Object.keys(e).forEach(function(r){t[r]=e[r]})}return e}();r.QuotaHistory=n},{}],28:[function(e,t,r){"use strict";/*
 * Pelion Device Management JavaScript SDK
 * Copyright Arm Limited 2018
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
Object.defineProperty(r,"__esModule",{value:!0});var n=e("./quotaHistory"),o=e("./servicePackageAdapter");r.mapQuotaHistory=function(e){return new n.QuotaHistory({id:e.id,createdAt:e.added,delta:e.amount,accountId:null!==e.reservation?e.reservation.account_id:null,campaignName:null!==e.reservation?e.reservation.campaign_name:null,servicePackage:o.mapQuotaHistoryServicePackage(e.service_package),reason:e.reason})}},{"./quotaHistory":27,"./servicePackageAdapter":30}],29:[function(e,t,r){"use strict";/*
 * Pelion Device Management JavaScript SDK
 * Copyright Arm Limited 2018
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
Object.defineProperty(r,"__esModule",{value:!0});var n=function(){function e(e){var t=this;Object.keys(e).forEach(function(r){t[r]=e[r]})}return e}();r.ServicePackage=n},{}],30:[function(e,t,r){"use strict";/*
 * Pelion Device Management JavaScript SDK
 * Copyright Arm Limited 2018
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
Object.defineProperty(r,"__esModule",{value:!0});var n=e("../../common/functions"),o=function(){function e(e,t){var r=this;this._api=t,Object.keys(e).forEach(function(t){r[t]=e[t]})}return e.prototype.delete=function(e){var t=this;return n.asyncStyle(function(e){t._api.deletePsk(t.endpointName,e)},e)},e}();r.PreSharedKey=o},{"../../common/functions":42}],34:[function(e,t,r){"use strict";Object.defineProperty(r,"__esModule",{value:!0});var n=e("./preSharedKey");r.mapToSDK=function(e,t){return new n.PreSharedKey({endpointName:e.endpoint_name,createdAt:e.created_at,secretHex:null},t)},r.mapFrom=function(e,t){return new n.PreSharedKey({endpointName:e.endpointName,secretHex:e.secretHex},t)},r.mapToSpec=function(e){return{endpoint_name:e.endpointName,secret_hex:e.secretHex}}},{"./preSharedKey":33}],35:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
Object.defineProperty(r,"__esModule",{value:!0});var _=e("./sdkError"),b=e("./tlvDecoder");r.asyncStyle=n,r.asyncStyleWithTimeout=o,r.apiWrapper=i,r.encodeBase64=a,r.decodeBase64=s,r.encodeInclude=u,r.snakeToCamel=c,r.camelToSnake=p,r.extractFilter=l,r.encodeFilter=d,r.decodeFilter=f,r.ensureArray=g,r.matchWithWildcard=m,r.dateToBillingMonth=h,r.isThisNode=y,r.promiseTimeout=v}).call(this,e("buffer").Buffer)},{"./sdkError":46,"./tlvDecoder":47,buffer:90}],43:[function(e,t,r){"use strict";/*
 * Pelion Device Management JavaScript SDK
 * Copyright Arm Limited 2018
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
Object.defineProperty(r,"__esModule",{value:!0}),r.generateId=function(){return""+Date.now()+Math.floor(1e4*Math.random())}},{}],44:[function(e,t,r){"use strict";Object.defineProperty(r,"__esModule",{value:!0}),r.executeForAll=function(e,t){var r=function(n){return e({after:n}).then(function(e){var n=e.data,o=e.hasMore,i=n.map(function(e){var r=e.id;return t(r)});return Promise.all(i).then(function(){return o?r(n[n.length-1].id):null})})};return r()}},{}],45:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
var n=this&&this.__extends||function(){var e=function(t,r){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(t,r)};return function(t,r){function n(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(n.prototype=r.prototype,new n)}}();Object.defineProperty(r,"__esModule",{value:!0});var o=e("./observer"),i=e("../../../legacy/common/functions"),a=function(e){function t(t){var r=e.call(this)||this;return t&&(r.filter=t),r}return n(t,e),t.prototype.filterFunc=function(e){if(this.filter)for(var t in this.filter)if(-1===i.ensureArray(this.filter[t]).indexOf(e[t]))return!1;return!0},t.prototype.notify=function(t){this.subscribed&&this.filterFunc(t)&&e.prototype.notify.call(this,t)},t.prototype.unsubscribe=function(){this.subscribed=!1,e.prototype.clearListeners.call(this)},t}(o.Observer);r.DeviceStateObserver=a},{"../../../legacy/common/functions":42,"./observer":86}],85:[function(e,t,r){"use strict";var n=this&&this.__extends||function(){var e=function(t,r){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(t,r)};return function(t,r){function n(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(n.prototype=r.prototype,new n)}}();Object.defineProperty(r,"__esModule",{value:!0});/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
var o=e("./observer"),i=function(e){function t(){return e.call(this)||this}return n(t,e),t.prototype.unsubscribe=function(){e.prototype.clearListeners.call(this)},t}(o.Observer);r.MasterObserver=i},{"./observer":86}],86:[function(e,t,r){"use strict";/*
* Pelion Device Management JavaScript SDK
* Copyright Arm Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
