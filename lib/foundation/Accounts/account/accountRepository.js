    ...
    AccountRepository.prototype.apiKeys = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_1.SubtenantApiKeyAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    /**
* create
    ...
    AccountRepository.prototype.darkThemeBrandingColors = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_3.SubtenantDarkThemeColorAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.darkThemeBrandingImages = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_4.SubtenantDarkThemeImageAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.lightThemeBrandingColors = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_5.SubtenantLightThemeColorAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.lightThemeBrandingImages = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_6.SubtenantLightThemeImageAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.list = function (options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_2.AccountAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.trustedCertificates = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_7.SubtenantTrustedCertificateAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.userInvitations = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_8.SubtenantUserInvitationAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.users = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_10.Page(data, data.data, index_9.SubtenantUserAdapter.fromApi));
            }, null);
        };
        return new index_10.Paginator(pageFunc, options);
    };
