    ...
    UpdateCampaignRepository.prototype.deviceMetadata = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_3.Page(data, data.data, index_2.CampaignDeviceMetadataAdapter.fromApi));
            }, null);
        };
    ...
    UpdateCampaignRepository.prototype.list = function (options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_3.Page(data, data.data, index_1.UpdateCampaignAdapter.fromApi));
            }, null);
        };
        return new index_3.Paginator(pageFunc, options);
    };
